  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-10">
      ...
      <p className="mt-1 text-sm text-zinc-500">
        Gelöschte Ordner und Boards. Wiederherstellen legt sie an ihren ursprünglichen Ort
        zurück — oder in die Übersicht, falls der übergeordnete Ordner ebenfalls gelöscht wurde.
      </p>
